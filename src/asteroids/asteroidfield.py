"""Asteroid field class to handle all asteroids."""
...
from asteroids.groups import updatable
...
class AsteroidField(pygame.sprite.Sprite):
    ...
    def spawn(self, radius: float, position: pygame.Vector2, velocity: pygame.Vector2) -> None:
        ...
        Args:
            radius: radius of new asteroid           position: position of new asteroid center
            velocity: initial speed of asteroid
        """
        asteroid = Asteroid(position.x, position.y, radius)
        asteroid.velocity = velocity

    def update(self, dt: float) -> None:
        """Update asteroid feild.
